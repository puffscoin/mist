...
Section Mist MIST_IDX
    ...
    ## Firewall - add rules
    #SimpleFC::AdvAddRule "Geth incoming peers (TCP:31313)" ""  6 1 1 2147483647 1 "$DATADIR\binaries\Geth\unpacked\geth.exe" "" "" "Ethereum" 31313 "" "" ""
    #SimpleFC::AdvAddRule "Geth outgoing peers (TCP:31313)" ""  6 2 1 2147483647 1 "$DATADIR\binaries\Geth\unpacked\geth.exe" "" "" "Ethereum" "" 31313 "" ""
    #SimpleFC::AdvAddRule "Geth UDP discovery (UDP:31313)" "" 17 2 1 2147483647 1 "$DATADIR\binaries\Geth\unpacked\geth.exe" "" "" "Ethereum" "" 31313 "" ""
...
Section "uninstall"
    ...
    #SimpleFC::AdvRemoveRule "Geth incoming peers (TCP:31313)"
    #SimpleFC::AdvRemoveRule "Geth outgoing peers (TCP:31313)"
    #SimpleFC::AdvRemoveRule "Geth UDP discovery (UDP:31313)"
