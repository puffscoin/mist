...
Section Mist MIST_IDX
    ...
    ## Firewall - add rules
    #SimpleFC::AdvAddRule "gpuffs incoming peers (TCP:31313)" ""  6 1 1 2147483647 1 "$DATADIR\binaries\gpuffs\unpacked\gpuffs.exe" "" "" "Ethereum" 31313 "" "" ""
    #SimpleFC::AdvAddRule "gpuffs outgoing peers (TCP:31313)" ""  6 2 1 2147483647 1 "$DATADIR\binaries\gpuffs\unpacked\gpuffs.exe" "" "" "Ethereum" "" 31313 "" ""
    #SimpleFC::AdvAddRule "gpuffs UDP discovery (UDP:31313)" "" 17 2 1 2147483647 1 "$DATADIR\binaries\gpuffs\unpacked\gpuffs.exe" "" "" "Ethereum" "" 31313 "" ""
...
Section "uninstall"
    ...
    #SimpleFC::AdvRemoveRule "gpuffs incoming peers (TCP:31313)"
    #SimpleFC::AdvRemoveRule "gpuffs outgoing peers (TCP:31313)"
    #SimpleFC::AdvRemoveRule "gpuffs UDP discovery (UDP:31313)"
